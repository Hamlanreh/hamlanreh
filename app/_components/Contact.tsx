...
export default function contact () {
    return (
        <section  id="contact" className="pt-40 min-h-screen">
            <div className="py-6 dark:bg-gray-800 dark:text-gray-50">
                <div className="grid max-w-6xl grid-cols-1 px-6 mx-auto lg:px-8 md:grid-cols-2 md:divide-x">
                    ...
                    <form className="flex flex-col py-6 space-y-6 md:py-0 md:px-6">
                        ...
                        <button type="button" className="bg-blue-500 text-white block mx-auto px-20 py-4 font-semibold rounded dark:bg-gray-100 dark:text-gray-800">Submit</button>
                    </form>
                </div>
            </div>
        </section>
