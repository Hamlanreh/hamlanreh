        ...
        <footer className="w-full mx-auto text-gray-700 bg-gray-100 body-font">
            <div className="container flex flex-col flex-wrap px-5 py-24 mx-auto md:items-center lg:items-start md:flex-row md:flex-no-wrap">
                <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
                    ...
                    <p className="mt-2 text-sm text-gray-500">Design, Code and Deploy!</p>
                    <div className="mt-4">
                ...
                <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
                    <div className="w-full px-4 lg:w-1/3 md:w-1/2">
                        ...
                        <nav className="mb-10 list-none">
                            <li className="mt-3">
                                <Link href="" className="text-gray-500 cursor-pointer hover:text-gray-900">About</Link>
                            </li>
                            <li className="mt-3">
                                <Link href="" className="text-gray-500 cursor-pointer hover:text-gray-900">Portfolio</Link>
                            </li>
                            <li className="mt-3">
                                <Link href="" className="text-gray-500 cursor-pointer hover:text-gray-900">Services</Link>
                            </li>
                            <li className="mt-3">
                                <Link href="" className="text-gray-500 cursor-pointer hover:text-gray-900">Contact</Link>
                            </li>
                        </nav>
                    </div>
                    <div className="w-full px-4 lg:w-1/3 md:w-1/2">
                    ...
                    <div className="w-full px-4 lg:w-1/3 md:w-1/2">
                        ...
                        <nav className="mb-10 list-none">
                            ...
                            <li className="mt-3">
                                <Link href="" className="text-gray-500 cursor-pointer hover:text-gray-900">+234-7084345275</Link>
                            </li>
                        </nav>
                    </div>
                </div>
            ...
            <div className="bg-gray-300">
                <div className="container px-5 py-4 mx-auto">
                    <p className="text-sm text-gray-700 capitalize xl:text-center">&copy; 2024 Hamlanreh. All rights reserved.</p>
                </div>
            </div>
        </footer>    
    )
